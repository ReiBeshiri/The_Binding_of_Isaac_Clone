...
public class SimplyDirectionMovement implements MovementStrategy {
    ...
    /**
     * 
     * @param dir Direction to perform movement.
     */
     ...
     * Note: Different from the player movements, instead, we can't have 
     * two movements "pressed" in the same time.
     */
    @Override
    ...
    /**
     * If a enemy that use this type of movement and collide with the border we need that 
     * he change his direction. 
     * Note: Otherwise if it is a bullet doesn't need to use this method, but simply disappear.
     */
