...
public class WorldEnvironmentImpl implements WorldEnvironment {
    ...
    private final HitBox hbDoorr = new RectangularHitBox(ModelUtility.getWorldWidth(), ModelUtility.getWorldHeight() / 2,  ProportionUtility.getHeightDoor(), ProportionUtility.getWidthDoor());
